...
function addrMove(){
	...
	if(checkboxs.length != 1){
		...
		var parent = checkboxs[0].closest('tr');
	    ...
	    let address = {
	        addr_nickname: move.dataset.addr_nickname,
	        postnum: move.dataset.postnum,
	        address: move.dataset.address,
	        detailedAddress: move.dataset.detailedAddress,
	        recipient_name: move.dataset.recipient_name,
	        recipient_phone: move.dataset.recipient_phone
