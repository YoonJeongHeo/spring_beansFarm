          ...
          <div id="con1">
              ...
              <div class="top_l">
                  ...
                  <table class="tb_title">
                      ...
                      <tr>
					<th><span>판매가</span></th>
					<td><span><fmt:formatNumber value="${productDTO.p_price}" pattern="#,###" /></span>
		...
		<div class="tab_basic">
			...
			<div class="tab_container">
				<div class="tab_content">
					<div>
						<img src="/upload/pd/${pdDTO.pd_image}" alt="제품 상세 정보">
					</div>
				</div>
				<div class="tab_content">
					<div>
						<img src="/resources/images/service/택배.jpg" alt="택배안내">
					</div>
				</div>
				<div class="tab_content">
