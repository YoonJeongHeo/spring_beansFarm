                        ...
                        <table class="mypageTabel">
                         ...
                         <c:forEach var="myreviewListAll" items="${myreviewListAll}">
                            ...
                            <tr class="mypageTableHo">
                                ...
                                <td width="5%" >
                                  		<c:choose>
											<c:when test="${myreviewListAll.r_star == 1}">
												<img src="../../../../resources/images/1-grade.png">
											</c:when>

											<c:when test="${myreviewListAll.r_star == 2}">
												<img src="../../../../resources/images/2-grade.png">
											</c:when>

											<c:when test="${myreviewListAll.r_star == 3}">
												<img src="../../../../resources/images/3-grade.png">
											</c:when>

											<c:when test="${myreviewListAll.r_star == 4}">
												<img src="../../../../resources/images/4-grade.png">
											</c:when>

											<c:when test="${myreviewListAll.r_star == 5}">
